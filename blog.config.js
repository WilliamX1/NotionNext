...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || '1bb5ba8ce1ae47e388250f8d71633b0c',
  ...
  CONTACT_EMAIL: 'huidxu@gmail.com', // 邮箱
  CONTACT_WEIBO: '', // 你的微博个人主页
  CONTACT_TWITTER: '', // 你的twitter个人主页
  CONTACT_GITHUB: 'https://github.com/WilliamX1', // 你的github个人主页
  CONTACT_TELEGRAM: 'https://t.me/WillamX1', // 你的telegram 地址 例如 https://t.me/tangly_1024
  ...
  // twikoo
  COMMENT_TWIKOO_ENV_ID: process.env.NEXT_PUBLIC_COMMENT_ENV_ID || 'https://twikoo.treasuredong.com', // TWIKOO地址 腾讯云环境填 envId；Vercel 环境域名地址（https://xxx.vercel.app)
  ...
  DESCRIPTION: process.env.NEXT_PUBLIC_DESCRIPTION || 'William', // 站点描述，被notion中的页面描述覆盖
